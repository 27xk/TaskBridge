...
contextBridge.exposeInMainWorld("taskBridge", {
  ...
  app: {
    ...
    onUpdateStatus: (callback: Listener<[unknown]>) => on("taskbridge:update-status", callback),
  },
  auth: {
  ...
  db: {
    ...
    purgeLocalTask: (localId: string) => ipcRenderer.invoke("db:tasks:purge-local", localId),
    clearLocalDeviceData: () => ipcRenderer.invoke("db:local:clear-device-data"),
    ...
    getQueueCounts: () => ipcRenderer.invoke("db:queue:counts"),
  ...
  task: {
    ...
    chooseImportJson: () => ipcRenderer.invoke("task:choose-import-json"),
    confirmImportJson: () => ipcRenderer.invoke("task:confirm-import-json"),
    getLastImportUndoSummary: () => ipcRenderer.invoke("task:get-last-import-undo-summary"),
    undoLastImportJson: () => ipcRenderer.invoke("task:undo-last-import-json"),
    importJson: () => ipcRenderer.invoke("task:import-json"),
    exportDiagnostics: () => ipcRenderer.invoke("task:export-diagnostics"),
  },
  sync: {
